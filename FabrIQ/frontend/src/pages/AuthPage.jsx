          ...
          <div className="p-10">
            ...
            {isLogin ? (
              <form onSubmit={handleLogin} className="space-y-5">
                ...
                <button
                  type="submit"
                  className="w-full bg-indigo-600 text-white py-3 rounded-lg font-medium hover:bg-indigo-700 transition-colors shadow-md mt-4 disabled:opacity-70 disabled:cursor-not-allowed"
